		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="span12">
					...
					<form action="member-password" method="post" class="form form-horizontal" id="passwordFrm">
						<input type="hidden" name="blnSendEmail" value="1">

						<cfif blnPassChecks EQ 0 and request.memberInactive is 0>
							<div class="alert alert-error">
								Please make sure all information below is correct. Then resubmit.
							</div>
						</cfif>
                        
                        <cfif blnPassChecks EQ 0 and request.memberInactive is 1>
							<div class="alert alert-error">
								Based on the Username / Email address you provided, our records indicate that this account is inactive.
							</div>
						</cfif>
						...
						<cfif blnSentEmail NEQ 1>
                            ...
                            <div class="control-group">
								To receive your login information, please enter the account username or email address with which you registered.
							</div>
                            
							<div class="control-group">
								<label class="control-label">Username/Email Address</label>
								<div class="controls">
									<input type="text" name="username" value="#username#" size="35" class="requiredField">
								</div>
							</div>
