		...
		<div id="myCarousel2" class="carousel slide" data-pause="onClick" style="margin-top:15px;margin-bottom:15px">
			...
			<div class="carousel-inner" >
				...
				<cfif rowEnded2 eq 1>
					...
					<cfif tileStart EQ 1 or tileStart EQ 2>
						<div class="page-spacer span12"></div>
						<div class="row" style="float:left;margin-left:25px; ">
					</cfif>
							<div class="span4" style="border:1px solid ##cccccc; text-align:center;min-width:250px; background-color:##FFF;text-align:center;">
								<div style="padding-top:10px">
									<img src="#courseImage#" style="height:50px;">
								</div>
								<div>
